...
int main() {
    ...
    switch (opcao) 
    {
        ...
        case 2:
          printf("Cidade %s tem área de %.2f.\n", nome1, area1);
          printf("Cidade %s tem área de %.2f.\n", nome2, area2);
           if(area1 == area2){
             printf("Empate!");
          } else if (area1 > area2) {
        ...
        case 5:
          printf("Cidade %s tem densidade demográfica de %.2f.\n", nome1, densidade1);
          printf("Cidade %s tem Densidade demográfica de %.2f.\n", nome2, densidade2);
    ...
    //Menu interativo para comparação de dois atributos.
    ...
    if (opcao1 == opcao2){
      ...
      //Impressão do resultado da soma dos atributos escolhidos.
